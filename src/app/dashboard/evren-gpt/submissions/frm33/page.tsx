...
export default function FRM33SubmissionPage() {
  ...
  const formFields = [
    {
      id: 'field_1',
      label: 'Health & Safety Management Policy',
      description:
        "Describe the organization's health and safety management policy",
      required: true
    },
    {
      id: 'field_2',
      label: 'Risk Assessment Process',
      description: 'Explain the risk assessment and mitigation process',
      required: true
    },
    {
      id: 'field_3',
      label: 'Safety Training Programs',
      description: 'Details of safety training programs in place',
      required: true
    },
    {
      id: 'field_4',
      label: 'Incident Reporting System',
      description: 'Describe the incident reporting and investigation system',
      required: true
    },
    {
      id: 'field_5',
      label: 'Safety Performance Metrics',
      description: 'Provide key safety performance indicators',
      required: true
    }
  ];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await apiClient.post('/frm33/submissions', payload, {
        tenantId
      });

      toast.success('FRM33 submitted successfully!');
    ...
    <div className='mx-auto max-w-4xl space-y-6 p-4 pt-6 md:p-8'>
      ...
      <div>
        <h1 className='text-3xl font-bold tracking-tight'>
          FRM33 - Safety Management
        </h1>
        <p className='text-muted-foreground mt-2'>
          Comprehensive safety management assessment
        </p>
      </div>
