...
export default function FRM35EvaluationsPage() {
  return (
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Final supervisor assessment - Triggered after FRM34 completion
          </p>
        </div>
        <Button
          variant='outline'
        ...
        <CardContent>
          <div className='space-y-2 text-sm'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <span className='font-medium'>FRM34 (Supervisor)</span>
            </div>
            <div className='flex items-center justify-between'>
