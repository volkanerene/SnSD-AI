...
export default function FRM33EvaluationsPage() {
  return (
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Supervisor assessment - Triggered after FRM32 completion
          </p>
        </div>
        <Button
          variant='outline'
        ...
        <CardContent>
          <div className='space-y-2 text-sm'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <span className='font-medium'>FRM32 (Contractor Admin)</span>
            </div>
            <div className='flex items-center justify-between'>
              <span className='text-muted-foreground'>Next Step:</span>
              <span className='font-medium'>Triggers FRM34 (Supervisor)</span>
            </div>
          </div>
        </CardContent>
      </Card>
